...
class User extends CI_Controller
{
  ...
  {
    $this->load->view('user/templates/header.php');
    $data['list_data'] = $this->M_user->select('tb_masuk_room');
    $this->load->view('user/tabel/tabel_masukroom', $data);
    $this->load->view('user/templates/footer.php');
  }
  ...
  //{
  //$this->load->view('user/templates/header.php');
  //$data['list_data'] = $this->M_user->select('tb_keluar_room');
  //$this->load->view('user/tabel/tabel_keluarroom',$data);
  //$this->load->view('user/templates/footer.php');
  //}
