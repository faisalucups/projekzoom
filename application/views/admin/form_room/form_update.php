          ...
          <div class="col-md-12">
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                ...
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_room_update') ?>" role="form" method="post">
                        ...
                        <?php foreach ($id_room as $d) { ?>
                          <div class="box-body">
                            <div class="form-group" style="display:inline-block;">
                              ...
                              <input type="text" required name="kode_room" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_room" placeholder="Kode Room " value="<?= $d->kode_room ?>">
                            </div>
                            <div class="form-group" style="display:inline-block;">
                              <label for="nama_room" style="width:73%;">Nama Room</label>
                              <input type="text" required name="nama_room" style="width:90%;margin-right: 67px;" class="form-control" id="nama_room" placeholder="Nama Room" value="<?= $d->nama_room ?>">
                            </div>
                            <div class="form-group" style="display:inline-block;">
