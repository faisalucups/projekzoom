            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Room Zoom</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_room_insert') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group" style="display:inline-block;">
                        <label for="kode_room" style="width:87%;margin-left: 12px;">Kode Room</label>
                        <input type="text" name="kode_room" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_room" placeholder="Kode Room">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_room" style="width:73%;">Nama Room</label>
                        <input type="text" name="nama_room" style="width:90%;margin-right: 67px;" class="form-control" id="nama_room" placeholder="Nama Room">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                      ...
                      <div class="box-footer" style="width:93%;">
                        ...
                        <a type="button" class="btn btn-info" style="width:13%;margin-right:29%" href="<?= base_url('admin/tabel_room') ?>" name="btn_listroom"><i class="fa fa-table" aria-hidden="true"></i> Lihat Room</a>
