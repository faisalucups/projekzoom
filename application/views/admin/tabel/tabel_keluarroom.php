...
<head>
  ...
  <title>AdminLTE 2 | Table Keluar Room</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li>Tables</li>
          <!--li class="active"><a href="<?= base_url('admin/tabel_keluarroom') ?>">Tabel Keluar Room</a></-li-->
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/tabel_masukroom') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data Keluar Room</a>
                <a href="<?= base_url('report/KeluarroomManual') ?>" style="margin-bottom:10px;" type="button" class="btn btn-danger" name="laporan_data"><i class="fa fa-file-text" aria-hidden="true"></i> invoice manual</a>
