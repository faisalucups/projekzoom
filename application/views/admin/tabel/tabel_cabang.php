...
<head>
    ...
    <title>AdminLTE 2 | Table Room</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>Tables</li>
                    <li class="active"><a href="<?= base_url('admin/tabel_cabang') ?>">Tabel Cabang</a></li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> List Masuk Room</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <a href="<?= base_url('admin/form_cabang') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Cabang</a>
                                        ...
                                        <tr>
                                            <?php if (is_array($list_data)) { ?>
                                                ...
                                                <?php foreach ($list_data as $dd) : ?>
                                                    <td><?= $no ?></td>
                                                    <td><?= $dd->kode_cabang ?></td>
                                                    <td><?= $dd->nama_cabang ?></td>
                                                    <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_cabang/' . $dd->id_cabang) ?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                                    <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('admin/delete_cabnag/' . $dd->id_cabang) ?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $no++; ?>
                                    <?php endforeach; ?>
                                <?php } else { ?>
