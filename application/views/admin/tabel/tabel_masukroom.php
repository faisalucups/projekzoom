...
<head>
  ...
  <title>AdminLTE 2 | Table Masuk Room Zoom</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li>Tables</li>
          <li class="active"><a href="<?= base_url('admin/tabel_masukroom') ?>">Tabel Masuk Room</li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> Daftar Masuk Room</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/form_masukroom') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Room Zoom</a>
                    ...
                    <tr>
                      <?php if (is_array($list_data)) { ?>
                        ...
                        <?php foreach ($list_data as $dd) : ?>
                          ...
                          <td><?= $dd->room ?></td>
                          <!--td><--?= $dd->jumlah ?></-td-->
                          <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_room/' . $dd->id) ?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                          <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('admin/delete_participant/' . $dd->id) ?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
