    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?= base_url('admin/tabel_masukroom') ?>">Tables</a></li>
          <li class="active">Tambah Room Keluar</li>
        </ol>
      </section>
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Room Keluar</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <?php foreach ($list_data as $d) { ?>
                          <label for="id" style="margin-left:220px;display:inline;">Id</label>
                          <input type="text" name="id" style="margin-left:84px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?= $d->id ?>">
                      </div>
                      <div class="form-group">
                        <label for="nama" style="margin-left:220px;display:inline;">Nama</label>
                        <input type="text" name="nama" style="margin-left:66px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?= $d->nama ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group" style="margin-bottom:40px;">
                        <label for="cabang_si" style="margin-left:220px;display:inline;">Cabang si</label>
                        <input type="text" name="cabang_si" style="margin-left:117px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?= $d->cabang_si ?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="kode_room" style="width:87%;margin-left: 12px;">Jam</label>
                        <input type="text" name="jam" readonly="readonly" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="jam" value="<?= $d->jam ?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="kode_room" style="width:87%;margin-left: 12px;">selesai</label>
                        <input type="text" name="selesai" readonly="readonly" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="selesai" value="<?= $d->selesai ?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_room" style="width:73%;">Topik</label>
                        <input type="text" name="topik" readonly="readonly" style="width:90%;margin-right: 67px;" class="form-control" id="topik" value="<?= $d->topik ?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="room" style="width:73%;">Room</label>
                        <select class="form-control" name="room" style="width:110%;margin-right: 18px;">
