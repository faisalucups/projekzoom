...
<head>
  ...
  <title>Web Room Zoom | Data Masuk Room Zoom</title>
  ...
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            ...
            <li><a href="<?php echo base_url('login') ?>assets/web_admin/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Input Data Masuk Room Zoom
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="#">Forms</a></li>
          <li class="active">Data Masuk Room Zoom</li>
        </ol>
      </section>
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Data Masuk Room Zoom</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_dataroom_masuk_insert') ?>" role="form" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="box-body">
                          ...
                          <div class="form-group" style="display:inline-block;">
                            ...
                            <input type="text" name="selesai" required style="width:90%;margin-right: 67px;" class="form-control" id="selesai" placeholder="Masukan Jam...">
                          </div>
                        </div>
                        <div class="box-body">
                          <div class="form-group" style="display:inline-block;">
                            <label for="topik" style="width:87%;margin-left: 12px;">Topik</label>
                            <input type="text" name="topiK" required style="width: 90%;margin-right: 67px; margin-left: 11px;" class="form-control" id="topik" placeholder="Ketik disini...">
                          </div>
                          <div class="form-group" name="Room" style="display:inline-block;">
                          ...
                          <div class="box-body">
                            <div class="form-group" style="display:inline-block;">
                              <button type="reset" class="btn btn-basic" name="btn_reset" style="width:87%;margin-left: 12px;"><i class="fa fa-eraser" aria-hidden="true"></i> Reset</button>
                            </div>
                          </div>
                          <!-- /.box-body -->
                          <div class="box-footer" style="width:93%;">
                            <a type="button" class="btn btn-default" style="width:10%;margin-right:26%" onclick="history.back(-1)" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                            <a type="button" class="btn btn-info" style="width:14%;margin-right:29%" href="<?= base_url('admin/tabel_masukroom') ?>" name="btn_listroom"><i class="fa fa-table" aria-hidden="true"></i> Lihat List Room</a>
