      ...
      <section class="sidebar">
        ...
        <li class="treeview">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('admin/form_masukroom') ?>"><i class="fa fa-circle-o"></i> Tambah Data Masuk Room</a></li>
              <li><a href="<?php echo base_url('admin/form_room') ?>"><i class="fa fa-circle-o"></i> Tambah Room Zoom</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url('admin/tabel_masukroom') ?>"><i class="fa fa-circle-o"></i> Tabel Masuk Room</a></li>
              <!--li><a href="<--?= base_url('admin/tabel_keluarroom') ?>"><i class="fa fa-circle-o"></i> Tabel Keluar Room</a></li-->
              <li><a href="<?= base_url('admin/tabel_room') ?>"><i class="fa fa-circle-o"></i> Tabel Room</a></li>
            </ul>
        ...
        <div class="row">
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                <?php if (!empty($listMasukRoom)) { ?>
                  <?php foreach ($stokMasukRoom as $d) { ?>
                    <h3><?= $d->id ?></h3>
                  <?php } ?>
                <?php } else { ?>
                  <h3>0</h3>
              ...
              <a href="<?= base_url('admin/tabel_masukroom') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                <?php if (!empty($stokKeluarRoom)) { ?>
                  <?php foreach ($stokKeluarRoom as $d) { ?>
                    <h3><?= $d->nama ?></h3>
                  <?php } ?>
                <?php } else { ?>
                  <h3>0</h3>
              ...
              <a href="<?= base_url('admin/tabel_room') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6">
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
              ...
              <a href="<?= base_url('admin/tabel_keluarroom') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
